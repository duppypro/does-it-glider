...
export function get_max_glider_count() {
    if (cached_max_glider_count !== null) return cached_max_glider_count
    cached_max_glider_count = Number(localStorage.getItem(MAX_GLIDER_COUNT_KEY) || '0')
    return cached_max_glider_count
}

export function set_max_glider_count(count) {
    cached_max_glider_count = count
